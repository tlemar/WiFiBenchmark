...
public class ThroughputTestActivity extends AppCompatActivity {

    private DrawerLayout drawerLayout;
    private Toolbar toolbar;

    ThroughputFragment mThroughFrag ;
...
//                        .setAction("Action", null).show();
                mThroughFrag.getCurrentFragment().tv.setText("test");
            }
        });

        mThroughFrag = new ThroughputFragment();

        getSupportFragmentManager().beginTransaction()
                .replace(R.id.main_fragment_holder, mThroughFrag)
                .commit();
        Logger.e("oncreate");
    }
    ...
    private void initDrawer() {
        ...
        ArrayAdapter<String> navigationDrawerAdapter = new ArrayAdapter<>(
                ThroughputTestActivity.this, R.layout.drawer_list_item, R.id.tv_list_item, leftSliderData);
